...
def exercise04(more_temperatures, iot_sensor_points, a, b, c, d, e):
    ...
    #2
    sensor = list(iot_sensor_points.values())
    temperatures = temperatures + sensor
    #3
...
def exercise06(n):
    ...
    sum_n = sum(list)
    length_n = len(list)
    average_n = float(sum(list)) / len(list)
...
def display_menu(menu):
    ...
    for i,value in enumerate(menu,1):
        print (i,value)
    ...
    if order not in i:
        ...
        order_list.append(menu[user_order-1])
...
def exercise09():
    ...
    dogs = ['https://goo.gl/images/7heifs', 'https://goo.gl/images/mPHjH7','https://goo.gl/images/DmTPF5', 'https://goo.gl/images/G1ATYa', 'https://goo.gl/images/AZR2UY', 
    'https://goo.gl/images/CngwY6', 
    'https://goo.gl/images/tJgrw2', 
    'https://goo.gl/images/E46SCZ', 
    'https://goo.gl/images/x4sLci', 
    'https://goo.gl/images/nQCvpW']
    for link in dogs: 
